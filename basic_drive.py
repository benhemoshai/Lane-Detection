...
#Creates full length lines from pixel points.   
...
#Draws lines and a trapezoid polygon onto the input image.   
...
def crop_im(frame):
    ...
    roi_vertices = np.array([[(width * 0.28, height * 0.87), #bottom left
...
#Main
vid = cv2.VideoCapture('project1/day-drive.mp4')
